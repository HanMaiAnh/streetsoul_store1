...
<div class="container">
        ...
        <tbody>
            ...
            <tr>
                <td class="product-name">
                    ...
                    <img src="/streetsoul_store1/public/images/<?php echo htmlspecialchars($image); ?>" width="50" alt="<?php echo htmlspecialchars($name); ?>"> 
    ...
    <!-- Form "Mua ngay" -->
    <form method="GET" action="/streetsoul_store1/view/client/order.php">
