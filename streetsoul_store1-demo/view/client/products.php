...
<!-- <div style="width: 100%; margin: 0 auto 30px; padding: 0;">
    <img src="/streetsoul_store1/public/images/banner.jpg" alt="Banner Sản phẩm" 
                ...
                <?php foreach ($allProducts as $product): ?>
                    <div class="product">
                        <a href="productDetail.php?id=<?php echo $product['id']; ?>" style="text-decoration: none; color: inherit;">
                            <img src="/streetsoul_store1/public/images/<?php echo $product['image']; ?>" alt="" style="width: 100%; height: 200px; object-fit: cover; border-radius: 8px;">
